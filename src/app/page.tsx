      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 pb-20">
        <div className="w-full max-w-[500px] bg-[#537D6B] rounded-2xl shadow-2xl p-8 md:p-12 text-white">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold tracking-tight mb-2">WELCOME TO NEU LIBRARY!</h2>
            <p className="text-white/90 text-sm">Tap ID or Log In</p>
            <p className="text-white/70 text-xs mt-2 italic px-4">
              Please identify yourself to record your library entry. Your data helps us improve library services.
            </p>
          </div>
          ...
          <div className="mt-8 bg-[#3D5C4E] rounded-lg p-5">
            <h3 className="font-bold text-sm mb-3">Why Log In?</h3>
            <ul className="text-xs space-y-2 list-disc list-inside text-white/90 font-medium">
              ...
              <li>Help NEU efficiently track facility utilization.</li>
            </ul>
          </div>
        </div>
      </main>
